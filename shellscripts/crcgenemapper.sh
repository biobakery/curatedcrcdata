...
$REXEC CMD BATCH --vanilla "--args GSE12225-GPL3676 $REPOSHOME/GENEMAPS/GSE12225-GPL3676.csv $DATAHOME/GSE12225-GPL3676/PROCESSED/DEFAULT/GSE12225-GPL3676_default_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE12225-GPL3676_genemapping.log
