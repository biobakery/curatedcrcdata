...
$REXEC CMD BATCH --vanilla "--args GSE13294 $REPOSHOME/GENEMAPS/affy_hg_u133_plus_2.csv $DATAHOME/GSE13294/PROCESSED/RMA/GSE13294_frma_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE13294_genemapping.log
...
$REXEC CMD BATCH --vanilla "--args GSE14333 $REPOSHOME/GENEMAPS/affy_hg_u133_plus_2.csv $DATAHOME/GSE14333/PROCESSED/RMA/GSE14333_frma_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE14333_genemapping.log
$REXEC CMD BATCH --vanilla "--args GSE17536 $REPOSHOME/GENEMAPS/affy_hg_u133_plus_2.csv $DATAHOME/GSE17536/PROCESSED/RMA/GSE17536_frma_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE17536_genemapping.log
...
$REXEC CMD BATCH --vanilla "--args GSE17538-GPL570 $REPOSHOME/GENEMAPS/affy_hg_u133_plus_2.csv $DATAHOME/GSE17538-GPL570/PROCESSED/RMA/GSE17538-GPL570_frma_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE17538-GPL570_genemapping.log
...
$REXEC CMD BATCH --vanilla "--args GSE2109 $REPOSHOME/GENEMAPS/affy_hg_u133_plus_2.csv $DATAHOME/GSE2109/PROCESSED/RMA/GSE2109_frma_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE2109_genemapping.log
...
$REXEC CMD BATCH --vanilla "--args GSE26682-GPL570 $REPOSHOME/GENEMAPS/affy_hg_u133_plus_2.csv $DATAHOME/GSE26682-GPL570/PROCESSED/RMA/GSE26682-GPL570_frma_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE26682-GPL570_genemapping.log
...
$REXEC CMD BATCH --vanilla "--args GSE39582 $REPOSHOME/GENEMAPS/affy_hg_u133_plus_2.csv $DATAHOME/GSE39582/PROCESSED/RMA/GSE39582_frma_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE39582_genemapping.log
...
$REXEC CMD BATCH --vanilla "--args GSE16125-GPL5175 $REPOSHOME/GENEMAPS/gpl-5175.csv $DATAHOME/GSE16125-GPL5175/PROCESSED/DEFAULT/GSE16125-GPL5175_default_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE16125-GPL5175_genemapping.log
$REXEC CMD BATCH --vanilla "--args GSE24549-GPL5175 $REPOSHOME/GENEMAPS/gpl-5175.csv $DATAHOME/GSE24549-GPL5175/PROCESSED/DEFAULT/GSE24549-GPL5175_default_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE24549-GPL5175_genemapping.log
$REXEC CMD BATCH --vanilla "--args GSE24550-GPL5175 $REPOSHOME/GENEMAPS/gpl-5175.csv $DATAHOME/GSE24550-GPL5175/PROCESSED/DEFAULT/GSE24550-GPL5175_default_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE24550-GPL5175_genemapping.log
...
$REXEC CMD BATCH --vanilla "--args GSE12225-GPL3676 $REPOSHOME/GENEMAPS/GPL3676.csv $DATAHOME/GSE12225-GPL3676/PROCESSED/DEFAULT/GSE12225-GPL3676_default_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE12225-GPL3676_genemapping.log
...
$REXEC CMD BATCH --vanilla "--args GSE2630 $REPOSHOME/GENEMAPS/GPL2006.csv $DATAHOME/GSE2630/PROCESSED/DEFAULT/GSE2630_default_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE2630_genemapping.log
...
#$REXEC CMD BATCH --vanilla "--args GSE3294 $REPOSHOME/GENEMAPS/GPL2829.csv $DATAHOME/GSE3294/PROCESSED/DEFAULT/GSE3294_default_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/GSE3294_genemapping.log
...
$REXEC CMD BATCH --vanilla "--args TCGA-COAD $REPOSHOME/GENEMAPS/TCGA-COAD.csv $DATAHOME/TCGA-COAD/PROCESSED/DEFAULT/TCGA-COAD_default_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/TCGA-COAD_genemapping.log
...
$REXEC CMD BATCH --vanilla "--args TCGA-READ $REPOSHOME/GENEMAPS/TCGA-READ.csv $DATAHOME/TCGA-READ/PROCESSED/DEFAULT/TCGA-READ_default_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/TCGA-READ_genemapping.log

$REXEC CMD BATCH --vanilla "--args TCGA-RNASeqV2-READ $REPOSHOME/GENEMAPS/TCGA-RNASeqV2-READ.csv $DATAHOME/TCGA-RNASeqV2-READ/PROCESSED/DEFAULT/TCGA-RNASeqV2-READ_default_curated_exprs.txt $REPOSHOME/MAPPED" $SRCHOME/geneMapper.R $LOG/TCGA-RNASeqV2-READ_genemapping.log
