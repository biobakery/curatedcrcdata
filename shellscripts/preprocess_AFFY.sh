...
$REXEC CMD BATCH --vanilla "--args GSE11237 $DATAHOME $CURATED/GSE11237_curated_pdata.txt" $SRCHOME/preprocess_AFFY.R $LOG/GSE11237_preprocess_AFFY.log
...
#$REXEC CMD BATCH --vanilla "--args GSE2630 $DATAHOME $CURATED/GSE2630_curated_pdata.txt" $SRCHOME/preprocess_AFFY.R $LOG/GSE2630_preprocess_AFFY.log
$REXEC CMD BATCH --vanilla "--args GSE26682-GPL96 $DATAHOME $CURATED/GSE26682-GPL96_curated_pdata.txt" $SRCHOME/preprocess_AFFY.R $LOG/GSE26682-GPL96_preprocess_AFFY.log
$REXEC CMD BATCH --vanilla "--args GSE26682-GPL570 $DATAHOME $CURATED/GSE26682-GPL570_curated_pdata.txt" $SRCHOME/preprocess_AFFY.R $LOG/GSE26682-GPL570_preprocess_AFFY.log
$REXEC CMD BATCH --vanilla "--args GSE26906 $DATAHOME $CURATED/GSE26906_curated_pdata.txt" $SRCHOME/preprocess_AFFY.R $LOG/GSE26906_preprocess_AFFY.log
$REXEC CMD BATCH --vanilla "--args GSE28702 $DATAHOME $CURATED/GSE28702_curated_pdata.txt" $SRCHOME/preprocess_AFFY.R $LOG/GSE28702_preprocess_AFFY.log
$REXEC CMD BATCH --vanilla "--args GSE33113 $DATAHOME $CURATED/GSE33113_curated_pdata.txt" $SRCHOME/preprocess_AFFY.R $LOG/GSE33113_preprocess_AFFY.log
$REXEC CMD BATCH --vanilla "--args GSE39582 $DATAHOME $CURATED/GSE39582_curated_pdata.txt" $SRCHOME/preprocess_AFFY.R $LOG/GSE39582_preprocess_AFFY.log
$REXEC CMD BATCH --vanilla "--args GSE4045 $DATAHOME $CURATED/GSE4045_curated_pdata.txt" $SRCHOME/preprocess_AFFY.R $LOG/GSE4045_preprocess_AFFY.log
#$REXEC CMD BATCH --vanilla "--args GSE4526 $DATAHOME $CURATED/GSE4526_curated_pdata.txt" $SRCHOME/preprocess_AFFY.R $LOG/GSE4526_preprocess_AFFY.log
$REXEC CMD BATCH --vanilla "--args GSE45270 $DATAHOME $CURATED/GSE45270_curated_pdata.txt" $SRCHOME/preprocess_AFFY.R $LOG/GSE45270_preprocess_AFFY.log
